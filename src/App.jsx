    ...
    <>    
      <div className="w-full h-full bg-[#fcf8f6] flex justify-center flex-col-reverse py-10 px-4 lg:flex-row lg:gap-[10px] ">
        ...
        <div className="  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5    text-white">
          ...
          <div className=" ">
            <img src="src/assets/1.jpg " alt="" className='rounded-[20px]' />
          ...
          <div className=" ">
            <img src="src/assets/2.jpg" alt="" className='rounded-[20px]' />
          ...
          <div className=" ">
            <img src="src/assets/3.jpg" alt="" className='rounded-[20px]' />
          ...
          <div className=" ">
            <img src="src/assets/4.jpg" alt="" className='rounded-[20px]' />
          ...
          <div className=" ">
            <img src="src/assets/5.jpg" alt="" className='rounded-[20px]' />
          ...
          <div className=" ">
            <img src="src/assets/6.jpg" alt="" className='rounded-[20px]' />
          ...
          <div className=" ">
            <img src="src/assets/7.jpg" alt="" className='rounded-[20px]' />
          ...
          <div className=" ">
            <img src="src/assets/8.jpg" alt="" className='rounded-[20px]' />
          ...
          <div className=" ">
            <img src="src/assets/9.jpg" alt="" className='rounded-[20px]' />
